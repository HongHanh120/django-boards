...
class PasswordResetConfirmTests(TestCase):
    def setUp(self):
        ...
        self.uid = urlsafe_base64_encode(force_bytes(user.pk)).encode().decode('utf-8')
...
class InvalidPasswordResetConfirmTests(TestCase):
    def setUp(self):
        ...
        uid = urlsafe_base64_encode(force_bytes(user.pk)).encode().decode('utf-8')
